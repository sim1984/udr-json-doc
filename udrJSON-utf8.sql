...
BEGIN
  ...
  */
  ...
  FUNCTION Field(Self TY$POINTER, Name VARCHAR(32) /* = Idx */) RETURNS TY$POINTER;
...
BEGIN
  ...
  */
  ...
  FUNCTION IndexOfObject(Self TY$POINTER, Obj TY$POINTER) RETURNS INTEGER;
  FUNCTION Field(Self TY$POINTER, Name VARCHAR(32) /* = Idx */, Obj TY$POINTER = NULL /* Get */) RETURNS TY$POINTER;
