...
BEGIN
  ...
  */
  ...
  FUNCTION Field(Self TY$POINTER, Name VARCHAR(32) /* 1..N = Idx */) RETURNS TY$POINTER;
  ...
  FUNCTION SelfTypeName(Self TY$POINTER = NULL /* NULL - class function */) RETURNS VARCHAR(8);
END^
...
BEGIN
  ...
  */
  PROCEDURE ForEach
    (Self TY$POINTER) RETURNS (Idx Integer, Name VARCHAR(32), Obj TY$POINTER /* js$Base */);
...
BEGIN
  ...
  */
  ...
  FUNCTION MethodName(Self TY$POINTER, Name VARCHAR(32) = NULL /* Get */) RETURNS VARCHAR(32);
  FUNCTION MethodGenerate(Self TY$POINTER, Name VARCHAR(32), Obj TY$POINTER /* js$Base */)
...
BEGIN
  ...
  */
  ...
  PROCEDURE ForEach(Self TY$POINTER) RETURNS (Idx INTEGER,  Name VARCHAR(32), Obj TY$POINTER /* js$Meth */);

  FUNCTION Add_(Self TY$POINTER, Name VARCHAR(32), Obj TY$POINTER) RETURNS INTEGER;
  FUNCTION AddBoolean(Self TY$POINTER, Name VARCHAR(32), Bool BOOLEAN) RETURNS INTEGER;
  FUNCTION AddDouble(Self TY$POINTER, Name VARCHAR(32), Dbl DOUBLE PRECISION) RETURNS INTEGER;
  FUNCTION AddInteger(Self TY$POINTER, Name VARCHAR(32), Int_ INTEGER) RETURNS INTEGER;
  FUNCTION AddString(Self TY$POINTER, Name VARCHAR(32), Str VARCHAR(32765) CHARACTER SET NONE) RETURNS INTEGER;
  FUNCTION AddWideString(Self TY$POINTER, Name VARCHAR(32), WStr BLOB SUB_TYPE TEXT) RETURNS INTEGER;

  FUNCTION Delete_(Self TY$POINTER, Idx Integer) RETURNS SMALLINT;
  FUNCTION IndexOfName(Self TY$POINTER, Name VARCHAR(32)) RETURNS INTEGER;
  FUNCTION IndexOfObject(Self TY$POINTER, Obj TY$POINTER) RETURNS INTEGER;
  FUNCTION Field(Self TY$POINTER, Name VARCHAR(32) /* 1..N = Idx */, Obj TY$POINTER = NULL /* Get */) RETURNS TY$POINTER;
  ...
  FUNCTION NameOf(Self TY$POINTER, Idx INTEGER) RETURNS VARCHAR(32);
  ...
  FUNCTION GetBooleanByName(Self TY$POINTER, Name VARCHAR(32)) RETURNS BOOLEAN;
  FUNCTION GetDoubleByName(Self TY$POINTER, Name VARCHAR(32)) RETURNS DOUBLE PRECISION;
  FUNCTION GetIntegerByName(Self TY$POINTER, Name VARCHAR(32)) RETURNS INTEGER;
  FUNCTION GetStringByName(Self TY$POINTER, Name VARCHAR(32)) RETURNS VARCHAR(32765) CHARACTER SET NONE;
  FUNCTION GetWideStringByName(Self TY$POINTER, Name VARCHAR(32)) RETURNS BLOB SUB_TYPE TEXT;
END^
...
BEGIN
  ...
  FUNCTION Field(Self TY$POINTER, Name VARCHAR(32)) RETURNS TY$POINTER
  ...
  FUNCTION Value_(Self TY$POINTER, Val VARCHAR(32765) CHARACTER SET NONE) RETURNS VARCHAR(32765) CHARACTER SET NONE
  ...
  FUNCTION SelfTypeName(Self TY$POINTER) RETURNS VARCHAR(8)
...
BEGIN
  PROCEDURE ForEach
    (Self TY$POINTER) RETURNS (Idx Integer, Name VARCHAR(32), Obj TY$POINTER)
  AS
...
BEGIN
  ...
  FUNCTION ParseString(String VARCHAR(32765) CHARACTER SET NONE, Conv BOOLEAN) RETURNS TY$POINTER
  ...
  FUNCTION GenerateString(Obj TY$POINTER, Conv BOOLEAN) RETURNS VARCHAR(32765) CHARACTER SET NONE
...
BEGIN
  ...
  FUNCTION MethodName(Self TY$POINTER, Name VARCHAR(32)) RETURNS VARCHAR(32)
    EXTERNAL NAME 'lkjson!ObjectMethodName'
    ENGINE UDR;

  FUNCTION MethodGenerate(Self TY$POINTER, Name VARCHAR(32), Obj TY$POINTER) RETURNS TY$POINTER
...
BEGIN
  ...
  FUNCTION Field(Self TY$POINTER, Name VARCHAR(32), Obj TY$POINTER) RETURNS TY$POINTER
...
BEGIN
  ...
  BEGIN
    RETURN (jsPtr IS NULL OR jsPtr = nullPtr);
  END
END^
...
AS
BEGIN
  FUNCTION Value_(Self TY$POINTER, Str VARCHAR(32765) CHARACTER SET NONE) RETURNS VARCHAR(32765) CHARACTER SET NONE
  ...
  FUNCTION Generate(Self TY$POINTER, Str VARCHAR(32765) CHARACTER SET NONE) RETURNS TY$POINTER
